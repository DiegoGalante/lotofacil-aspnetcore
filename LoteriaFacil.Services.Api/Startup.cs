...
using LoteriaFacil.Services.Api.Configurations;
using MediatR;
...
namespace LoteriaFacil.Services.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(s =>
            {
                ...
                {
                    Version = "v1",
                    Title = "LoteriaFacil Project",
                    Description = "LoteriaFacil API Swagger surface inspired in Equinox Project by Eduardo Pires",
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(s =>
            {
                s.SwaggerEndpoint("/swagger/v1/swagger.json", "LoteriaFacil Project API v1.1");
            });
        }
