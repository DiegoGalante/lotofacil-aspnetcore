...
{
    public class Person_Lottery : Entity
    {
        public Person_Lottery(Guid id, int concurse, string game, int hits, decimal ticket_amount, DateTime? game_checked, DateTime game_register, Lottery lottery, Person person)
        {
            this.Id = id;
        ...
        //public Person_Lottery(Guid id, int concurse, string game, int hits, decimal ticket_amount, DateTime? game_checked, DateTime game_register, List<Lottery> listlottery, Person person)
        //{
        //    this.Id = id;
        //    this.Concurse = concurse;
        //    this.Game = game;
        ...
        public Person_Lottery()
        {

        }

        //public IEnumerable<Lottery> ListLottery { get; private set; }
