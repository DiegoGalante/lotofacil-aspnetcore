...
{
    public class Type_LotteryRegisteredEvent : Event
    {
        public Type_LotteryRegisteredEvent(Guid id, string name, int tens_min, decimal bet_min, int hit_min, int hit_max)
        {
            this.Id = id;
            this.Name = name;
