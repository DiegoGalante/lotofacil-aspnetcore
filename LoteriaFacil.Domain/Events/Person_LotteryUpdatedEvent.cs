...
{
    public class Person_LotteryUpdatedEvent : Event
    {
        public Person_LotteryUpdatedEvent(Guid id, int concurse, string game, int hits, decimal ticket_amount, DateTime? game_checked, DateTime game_register, Lottery lottery, Person person)
        {
            Id = id;
            Concurse = concurse;
            Hits = hits;
