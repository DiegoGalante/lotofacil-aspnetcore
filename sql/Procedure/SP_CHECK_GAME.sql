USE [LoteriaFacil]
GO
/****** Object:  StoredProcedure [dbo].[SP_CHECK_GAME]    Script Date: 17/09/2019 18:44:47 ******/
SET ANSI_NULLS ON
GO
...
--INSERT INTO Person_Lottery (pes_id, pl_concurse, pl_game) values (1, 1675,'01-02-03-05-08-09-10-11-14-15-16-19-23-24-25' )
--	INSERT INTO Person_Lottery (pes_id, pl_concurse, pl_game) values (1, 1675,'01-02-03-05-08-09-10-11-14-15-17-19-22-23-25' )
--	INSERT INTO Person_Lottery (pes_id, pl_concurse, pl_game) values (1, 1675,'01-02-03-05-06-08-09-10-12-15-19-21-22-23-25' )
	...
	--	UPDATE Person_Lottery 
	--		SET Hits = @hit_pessoa, Id = @lot_id, Ticket_Amount = ISNULL(@ticket_amount, 0), Game_Checked = GETDATE()
